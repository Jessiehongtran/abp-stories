            ...
            <div style={{ background: '#EBF2E6', minHeight: '100vh', maxWidth: '100vw', display: 'flex', alignItems: 'center' }}>
                <div className="content" style={{ maxWidth: '600px', boxSizing: 'border-box', padding: '0 8% 6% 8%', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                    ...
                    <div className="text" style={{ display: 'flex', flexDirection: 'column', textAlign: 'left', fontSize: '18px', lineHeight: '140%', color: '#006B4E'}}>
                        <p style={{ fontFamily: 'Optimistic Display', fontSize: '30px', lineHeight: '116.5%' }}>Transitioning to a New Era</p>
                    ...
                    <Button text={"View Stories"} bgColor={"#289664"} textColor={"#EBF2E6"} link={""} />
                </div>
